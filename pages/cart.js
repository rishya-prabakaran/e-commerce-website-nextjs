    ...
    if(!token){
        return(
            <div className="center-align">
                ...
                <Link href="/login"><a><button className="btn #ac15c0 darken-3">Login</button></a></Link>
            </div>
        )
    }
    if(error){
    ...
    const TotalPrice = ()=>{
        return(
            <div className="container" style={{display:"flex",justifyContent:"space-between"}}>
                ...
                billingAddress={true}
                zipCode={true}
                stripeKey="pk_test_51IugcqSDOe70aIjRJrd3cnRDQJoyGOQukeZTtnn38CnplpgHHEUzuyQzKUrqvrPxCH7d8nnEbrwH8sQUZiC3SCGM00ZxTAJhtt"
